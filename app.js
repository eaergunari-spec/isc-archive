const entries = [
  { order: "01", country: "ROLIPEA", artist: "Lambrini Girls", song: "Cuntology 101", slug: "01-lambrini-girls", video: "20TDd19oA1Q", image: "01-lambrini-girls.webp", focus: "50% 43%" },
  { order: "02", country: "VERDE VERANO", artist: "Élise de Lune", song: "Bonne Nuit", slug: "02-elise-de-lune", video: "TnThIGhFn5Q", image: "02-elise-de-lune.webp", focus: "50% 42%" },
  { order: "03", country: "GÜNEŞ DİYARI", artist: "Meira Omar & LIAMOO", song: "MAZAA", slug: "03-meira-omar-liamoo", video: "oFO8UkkCd8Q", image: "03-meira-omar-liamoo.webp", focus: "50% 40%" },
  { order: "04", country: "SUPERLAND", artist: "Saint Levant", song: "Nails", slug: "04-saint-levant", video: "J7e70aw_x_E", image: "04-saint-levant.webp", focus: "50% 38%" },
  { order: "05", country: "KIRMIZI", artist: "HAYQ", song: "Mi Patmutyun / Մի պատմություն", slug: "05-hayq", video: "QGMFry9eKNc", image: "05-hayq.webp", focus: "50% 43%" },
  { order: "06", country: "CABURYA", artist: "Laura Pausini", song: "¿PORQUÉ TE VAS?", slug: "06-laura-pausini", video: "MjwPS-lfbhU", image: "06-laura-pausini.webp", focus: "50% 38%" },
  { order: "07", country: "STJOHN", artist: "Audrey Hobert", song: "Bowling alley", slug: "07-audrey-hobert", video: "ohh3-7FCzkQ", image: "07-audrey-hobert.webp", focus: "50% 42%" },
  { order: "08", country: "UZANMIŞIM KUMSALA", artist: "GALENA", song: "CHATGPT", slug: "08-galena", video: "2GCBHSnvJik", image: "08-galena.webp", focus: "50% 38%" }
];
...
if (entryGrid) {
    ...
    <article class="entry-card" data-entry="${entry.order}">
      <a class="entry-card-primary" href="entries/${entry.slug}.html" aria-label="Entry ${entry.order}: ${escapeAttr(entry.artist)} — ${escapeAttr(entry.song)} dosyasını aç">
        <div class="entry-card-image-wrap">
          <img class="entry-card-image" style="object-position:${entry.focus}" src="${entry.image}" alt="${escapeAttr(entry.artist)}" loading="lazy" decoding="async">
  ...
  function openPlayer(button) {
    ...
    frame.src = `https://www.youtube-nocookie.com/embed/${video}?autoplay=1&rel=0&modestbranding=1`;
    modal.hidden = false;
